...
namespace JoyconAPI
{
    public class Joycon
    {
        ...
        ///</summary>
        ///<returns>
        ///Returns true if a button is pressed, false if not
        ///</returns>
        ...
        ///<summary>
        ///Registers when a button is pressed and held
        ///</summary>
        ///<returns>
        ///Returns true if a button is pressed and held, false if not
        ///</returns>
        ...
        ///<summary>
        ///Registers when a button is released
        ///</summary>
        ///<returns>
        ///Returns true if a button is released, false if not
        ///</returns>
        ...
        ///<summary>
        ///Gets the coordinates of the stick's position
        ///The first Element of the array represents the X-Axis
        ///The second Element of the array represents the Y-Axis
        ///</summary>
        ///<returns>
        ///Returns a float-array with the current coordinates of the stick 
        ///</returns>
        ...
        ///<summary>
        ///Measures the rotation of the joycon
        ///</summary>
        ///<returns>
        ...
        ///</summary>
        ///<returns>
        ///Returns the rotation of the joycon as a Quaternion-object
        ///</returns>
        ...
        ///<summary>
        ///Disconnects the connected joycons
        ///</summary>
        public void Detach()
        {
            stop_polling = true;
        ...
        public void Update()
        {
            if (state > state_.NO_JOYCONS)
            {
                ...
                while (reports.Count > 0)
                {
                    ...
                    ts_de = report_buf[1];
                    DebugPrint(string.Format("Dequeue. Queue length: {0:d}. Packet ID: {1}. Timestamp: {2}. Lag to dequeue: {3}. Lag between packets (expect 15ms): {4}",
        ...
        ///<summary>
        ///Starts a new thread that calls Poll()
        ///</summary>
        public void Begin()
        {
        ...
        ///<summary>
        ///Sets rotation to origin
        ///Can be used with GetVector()
        ///</summary>
        ...
        ///<summary>
        ///Sets rumble for joycon
        ///</summary>
        ///<param name=low_freq>Lowest limit of frequence spectrum</param>
        ///<param name=high_freq>Highest limit of frequence spectrum</param>
        ///<param name=amp>Size of amplitude</param>
        ///<param name=time>Duration of vibration - Is optional</param>
